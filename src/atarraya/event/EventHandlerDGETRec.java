...
public class EventHandlerDGETRec implements EventHandlerSW,constants{
    ...
    public EventHandlerDGETRec(atarraya_frame _father) {
        TMType = TM_ENERGY;
        father = _father;    
 ...
 public void showMessage(String m){
    ...
    public void HandleEvent(event_sim e){
        ...
        switch(code){
                ...
                if(receiver == destination){
                    if(getNode(receiver).isSink(temp_tree)){
                        if(getNode(receiver).isActive(temp_tree)){
                            ...
                            InvalidateAllEventsFromIDFromTimeTOfTypeTyOfCodeC(receiver, temp_clock, type, SEND_REACTIVATE_MESSAGE, temp_tree);
                            ...
                            pushEvent(new event_sim(temp_clock+TIMEOUT_DELAY, temp_clock, receiver, receiver, SEND_REACTIVATE_MESSAGE, "",temp_tree,type));
                        }
                    }else{
                    ...
                    //I have to do this here or the broadcast will not work with a dead node.
            ...
            case RESET_MESSAGE:
                if(!getNode(receiver).getInfrastructure(temp_tree).isInitialState() && !getNode(receiver).isSink(temp_tree)){
                    ...
                    broadcast(temp_clock+getRandom(MAX_TX_DELAY_RANDOM), temp_clock, receiver, -1, RESET_MESSAGE, temp_data,temp_tree);
                }
                break;
            ...
            case SEND_RESET_MESSAGE:
                ...
                if(temp>-1){
                    ...
                    broadcast(temp_clock+getRandom(MAX_TX_DELAY_RANDOM), temp_clock, receiver, -1, RESET_MESSAGE, temp_data,temp);
            ...
            case SEND_HELLO_MESSAGE_TM:
                ...
                broadcast(temp_clock+getRandom(MAX_TX_DELAY_RANDOM), temp_clock, sender, -1, HELLO_MESSAGE_TM, "",temp_tree);
            ...
            case HELLO_MESSAGE_TM:
                ...
                broadcast(temp_clock+getRandom(MAX_TX_DELAY_RANDOM), temp_clock, receiver, sender, REPLY_MESSAGE_TM, "",temp_tree);
                break;

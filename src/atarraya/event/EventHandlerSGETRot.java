...
public class EventHandlerSGETRot implements EventHandlerSW,constants{
    ...
    public EventHandlerSGETRot(atarraya_frame _father) {
...
*/
                     ...
                     if(getNode(receiver).isSink()){
                        InvalidateAllEventsFromIDFromTimeTOfTypeTyOfCodeC(receiver, temp_clock, type,SEND_HELLO_MESSAGE_TM,temp);
            ...
            case SEND_RESET_MESSAGE:
                ...
                if(temp_tree == getNode(receiver).getActiveTree()){
                    ...
                    InvalidateAllEventsFromIDFromTimeTOfTypeTy(receiver, temp_clock+DELTA_TIME, type,temp_tree);
                    InvalidateAllEventsFromIDFromTimeTOfTypeTy(receiver, temp_clock+DELTA_TIME, SENSOR_PROTOCOL,temp_tree);
